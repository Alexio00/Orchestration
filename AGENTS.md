...
Канонический текст кандидата: GENERAL-5.md. После выпуска он закрепляется тегом v5.0.1. Раздел «Ядро General 5.0.1» ниже должен совпадать с ним дословно. Внешние системные инструкции среды имеют приоритет.
