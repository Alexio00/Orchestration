...
Статус: candidate репозиторного дистрибутива General 5.0.2.
Activation Bootstrap: 1.2.5.

Канонический candidate: `GENERAL-5.md`. После выпуска тег `v5.0.2` должен совпадать с ним. Раздел «Ядро General 5.0.2» ниже совпадает с ним дословно. Внешние системные инструкции среды имеют приоритет.
