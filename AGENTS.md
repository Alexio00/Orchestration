...
Канонический выпущенный текст: `GENERAL-5.md` в теге `v5.0.2`. Раздел «Ядро General 5.0.2» ниже совпадает с ним дословно. Внешние системные инструкции среды имеют приоритет.
