...
7. **Проверяй результат.** Сопоставь фактический результат с запросом, используя самую дешёвую надёжную проверку. Не выдавай симуляцию, частичный или непроверенный результат за завершённую работу. Не повторяй неудачную попытку без новой информации или смены подхода.
